    ...
    public static void main(String[] args) {
        try {
            ...
            for (int i = 1; i < n; i++) {
                ...
                // System.out.println("Index: " + i + ", Base: " + base + ", Value: " +
                // valueStr);
            ...
            // Ensure that x and y lists have the correct size
            if (x.size() < k || y.size() < k) {
                // System.out.println("Error: Insufficient data for interpolation. x or y size
                // is less than k.");
                return;
            }
